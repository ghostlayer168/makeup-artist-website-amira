...
const ServicesPageLoader = {
    ...
    initPreloader() {
        ...
        const messages = [
            "Laddar lyxiga tillgångar",
            "Initierar konstnärskap",
            "Förbereder upplevelsen",
            "Nästan klar"
        ];
        ...
        return `
            <div class="mobile-menu-container">
                ...
                <nav class="mobile-menu-nav">
                    <a href="../sv/index_sv.html" class="mobile-nav-link ${currentPage === 'index_sv.html' || currentPage === '' ? 'active' : ''}">
                        <span class="link-number">01</span>
                        <span class="link-text">Hem</span>
                    </a>
                    
                    <a href="../sv/index_sv.html#philosophy" class="mobile-nav-link">
                        <span class="link-number">02</span>
                        <span class="link-text">Filosofi</span>
                    </a>
                    
                    <a href="../sv/services_sv.html" class="mobile-nav-link ${currentPage === 'services_sv.html' ? 'active' : ''}">
                        <span class="link-number">03</span>
                        <span class="link-text">Tjänster</span>
                    </a>
                    
                    <a href="../sv/index_sv.html#portfolio" class="mobile-nav-link">
                        <span class="link-number">04</span>
                        <span class="link-text">Portfolio</span>
                    </a>
                    
                    <a href="../sv/index_sv.html#contact" class="mobile-nav-link">
                ...
                <a href="../sv/index_sv.html#contact" class="mobile-cta-btn">
    ...
    handleMobileNavLinkClick(e) {
        ...
        setTimeout(() => {
            if (href.includes('.html')) {
                ...
                if (href === '#hero' && window.location.pathname.includes('services_sv.html')) {
                    window.scrollTo({
                        top: 0,
                        behavior: 'smooth'
                    });
...
const ServicesPage = {
    ...
    handleNavLink(e) {
        ...
        if (href.includes('.html') && !href.includes('index_sv.html#')) {
            window.location.href = href;
            return;
        }
        ...
        if (href.includes('index_sv.html#')) {
            window.location.href = href;
        }
    },
    ...
    navigateTo(href) {
        ...
        if (href.includes('.html#')) {
            ...
            if (page === 'index_sv.html' || page === './index_sv.html') {
                if (window.location.pathname.includes('index_sv.html') || window.location.pathname === '/') {
                    if (section) {
    ...
    updateActiveNavLink() {
        ...
        navLinks.forEach(link => {
            ...
            if (linkHref === currentPage || 
                (currentPage === '' && linkHref === 'index_sv.html') ||
                (currentPage === 'services_sv.html' && linkHref === 'services_sv.html')) {
    ...
    bindEvents() {
        ...
        bookButtons.forEach(button => {
            button.addEventListener('click', (e) => {
                if (button.getAttribute('href') === '../sv/index_sv.html#contact') {
                    e.preventDefault();
                    
                    const serviceDetail = button.closest('.service-detail');
                    const serviceTitle = serviceDetail?.querySelector('.service-title')?.textContent || 'Tjänst';
                    
                    localStorage.setItem('selectedService', serviceTitle);
                    
                    window.location.href = '../sv/index_sv.html#contact';
                }
            });
        });
