...
const Navigation = {
    ...
    generateMobileMenuContent() {
        // Get current active language from main selector
        const activeLang = document.querySelector('.lang-code')?.textContent || 'SV';
        
        return `
            <div class="mobile-menu-container">
                <!-- Close button -->
                <button class="mobile-close-btn" aria-label="Stäng meny">
                ...
                <nav class="mobile-menu-nav">
                    ...
                    <a href="#portfolio" class="mobile-nav-link">
                        ...
                        <span class="link-text">Portfölj</span>
                    </a>
    ...
    bindMobileMenuEvents(overlay) {
        ...
        // Close by clicking on overlay (except the container)
    ...
    handleLanguageSelect(e) {
        ...
        switch(lang) {
            case 'en':
                targetUrl = '../en/index.html'; // English version
                break;
            case 'sv':
                targetUrl = '../sv/index_sv.html'; // Swedish version
                break;
            case 'ar':
                targetUrl = '../ar/index_ar.html'; // Arabic version
                break;
            default:
...
const ActiveNav = {
    ...
    bindEvents() {
        ...
        // Add handlers for smooth scroll to sections
    ...
    setActiveNavLink(sectionId) {
        ...
        this.navLinks.forEach(link => {
            ...
            // Compare considering that services-preview could be services
...
const PortfolioModal = {
    ...
    getPortfolioDescription(item) {
        ...
        return `Ett fantastiskt ${category.toLowerCase()} arbete av Amira med titeln "${title}". Detta mästerverk visar elegansen och sofistikerandet av österländsk couture-sminkkonst, som kombinerar traditionella tekniker med moderna estetiska ideal.`;
    },
    ...
    collectPortfolioImages() {
        ...
        portfolioItems.forEach((item, index) => {
            ...
            const category = item.querySelector('.portfolio-category')?.textContent || 'Okategoriserad';
    ...
    createModal() {
        ...
        // Create HTML for modal - FIXED VERSION
        const modalHTML = `
            <div class="modal-overlay" id="portfolioModal">
                <div class="modal-container">
                    <!-- Use empty button as styles are applied via ::before -->
                    <button class="modal-close" aria-label="Stäng modal"></button>
                    ...
                    <div class="modal-sidebar">
                        <div class="modal-header">
                            <h3 class="modal-title">Portfoliobild</h3>
                            <p class="modal-category">Kategori</p>
                        </div>
                        ...
                        <div class="modal-meta">
                            <div class="meta-grid">
                                ...
                                <div class="meta-item">
                                    <div class="meta-label">Plats</div>
                                    <div class="meta-value">Dubai, UAE</div>
                                </div>
                                <div class="meta-item">
                                    <div class="meta-label">Tjänst</div>
                                    <div class="meta-value">Brudsmink</div>
                                </div>
                            </div>
                        </div>
                        
                        <div class="modal-tech">
                            <span class="tech-tag">Traditionellt</span>
                            <span class="tech-tag">Guldackcent</span>
                            <span class="tech-tag">Handmålade</span>
                            <span class="tech-tag">Lyx</span>
                        </div>
                    </div>
                    
                    <div class="modal-hint">
                        <span class="hint-key">ESC</span> för att stänga • 
                        <span class="hint-key">←</span> 
                        <span class="hint-key">→</span> för att navigera
                    </div>
                </div>
            </div>
        `;
    ...
    bindEvents() {
        ...
        // Bind events to portfolio items
    ...
    openModal(index) {
        ...
        if (this.portfolioImages.length === 0) {
            ...
            if (this.portfolioImages.length === 0) {
                alert('Portföljbilder är inte laddade. Var god uppdatera sidan.');
                return;
            }
        }
...
const ContactForm = {
    ...
    handleSubmit(e) {
        ...
        if (!this.validateForm()) {
            this.showError('Vänligen fyll i alla obligatoriska fält korrekt.');
            return;
        }
    ...
    validateField(field) {
        ...
        if (field.type === 'email' && field.value.trim()) {
            ...
            if (!emailRegex.test(field.value)) {
                this.showFieldError(field, 'Vänligen ange en giltig e-postadress');
                isValid = false;
            }
        }
        ...
        if (field.type === 'tel' && field.value.trim()) {
            ...
            if (!phoneRegex.test(field.value.replace(/[\s\-\(\)]/g, ''))) {
                this.showFieldError(field, 'Vänligen ange ett giltigt telefonnummer');
                isValid = false;
            }
        }
    ...
    showSuccessMessage() {
        ...
        successDiv.innerHTML = `
            ...
            <h3 style="font-family: var(--font-display); margin-bottom: 15px;">Tack!</h3>
            <p style="margin-bottom: 25px; opacity: 0.8;">Din konsultationsförfrågan har mottagits.</p>
            ...
            ">
                <span>Skicka ett nytt meddelande</span>
...
const PageLoader = {
    init() {
        console.log('AMIRA Website - Österländsk Couture Sminkkonst');
        document.documentElement.classList.remove('no-js');
        
        // Restore language from localStorage
        this.restoreLanguage();
        
        // Check if there's a preloader
